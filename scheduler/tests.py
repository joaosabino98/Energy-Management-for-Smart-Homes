...
class PriorityTestCase(TestCase):
    def setUp(self):
        ...
        a1 = Appliance.objects.create(home=self.h1, name="Test")
    ...
    def test_low_priority_calculation(self):
        ...
        e1 = Execution.objects.create(home=self.h1, request_time=rt1,appliance=Appliance.objects.first(),profile=Profile.objects.get(pk=1))
        e2 = Execution.objects.create(home=self.h1, request_time=rt2,appliance=Appliance.objects.first(),profile=Profile.objects.get(pk=1))
        e3 = Execution.objects.create(home=self.h1, request_time=rt3,appliance=Appliance.objects.first(),profile=Profile.objects.get(pk=1)) 
    ...
    def test_infinite_execution_priority_calculation(self):
        ...
        e1 = Execution.objects.create(home=self.h1, request_time=rt1,appliance=Appliance.objects.first(),profile=Profile.objects.get(pk=4))
        e2 = Execution.objects.create(home=self.h1, request_time=rt2,appliance=Appliance.objects.first(),profile=Profile.objects.get(pk=4))
        e3 = Execution.objects.create(home=self.h1, request_time=rt3,appliance=Appliance.objects.first(),profile=Profile.objects.get(pk=4))
...
class LifecycleTestCase(TestCase):
    def setUp(self):
        ...
        a1 = Appliance.objects.create(home=self.h1, name="Test 1", maximum_duration_of_usage=timezone.timedelta(seconds=3))
        a1.profiles.set([p1])
...
class FullSchedulingTestCase(TestCase):
    def setUp(self):
        ...
        a1 = Appliance.objects.create(home=self.h1, name="Test 1", maximum_duration_of_usage=timezone.timedelta(seconds=7200))
        a1.profiles.set([p1])
        a1.save()        
        p2 = Profile.objects.create(name="Test 2", schedulability=INTERRUPTIBLE, priority=IMMEDIATE, maximum_delay=None, rated_power=400)
        a2 = Appliance.objects.create(home=self.h1, name="Test 2", maximum_duration_of_usage=timezone.timedelta(seconds=300))
        a2.profiles.set([p2])
        a2.save() 
        ...
        a3 = Appliance.objects.create(home=self.h1, name="Test 3", maximum_duration_of_usage=timezone.timedelta(seconds=7200))
        a3.profiles.set([p3])
        a3.save() 
...
class ComplexSchedulingTestCase(TestCase):
    def setUp(self):
        ...
        a2 = Appliance.objects.create(home=self.h1, name="Test 2", maximum_duration_of_usage=timezone.timedelta(seconds=3600))
        a2.profiles.set([p2])
        a2.save()
        p3 = Profile.objects.create(name="Test 3", schedulability=INTERRUPTIBLE, priority=IMMEDIATE,
            maximum_delay=None, rated_power=400)
        a3 = Appliance.objects.create(home=self.h1, name="Test 3", maximum_duration_of_usage=timezone.timedelta(seconds=300))
        a3.profiles.set([p3])
        a3.save()
        ...
        a4 = Appliance.objects.create(home=self.h1, name="Test 4", maximum_duration_of_usage=timezone.timedelta(seconds=3000))
        a4.profiles.set([p4])
        a4.save()
        p5 = Profile.objects.create(name="Test 5", schedulability=NONINTERRUPTIBLE, priority=NORMAL,
            maximum_delay=None, rated_power=6000)
        a5 = Appliance.objects.create(home=self.h1, name="Test 5", maximum_duration_of_usage=None)
        a5.profiles.set([p5])
        a5.save()
    ...
    def test_simple_scheduling(self):
        ...
        e2 = Execution.objects.create(home=self.h1, appliance=Appliance.objects.get(pk=2),profile=Profile.objects.get(pk=2))
        e3 = Execution.objects.create(home=self.h1, appliance=Appliance.objects.get(pk=3),profile=Profile.objects.get(pk=3))
        e4 = Execution.objects.create(home=self.h1, appliance=Appliance.objects.get(pk=4),profile=Profile.objects.get(pk=4))
        status1 = self.scheduler.schedule_execution(e1)
        status2 = self.scheduler.schedule_execution(e2)
        status3 = self.scheduler.schedule_execution(e3)
        status4 = self.scheduler.schedule_execution(e4)
    ...
    def test_anticipate_pending_executions(self):
        ...
        self.scheduler.schedule_execution(e1)
        self.scheduler.schedule_execution(e2)
        e3 = Execution.objects.create(home=self.h1, appliance=Appliance.objects.get(pk=2),profile=Profile.objects.get(pk=2))
        ...
        e7 = Execution.objects.create(home=self.h1, appliance=Appliance.objects.get(pk=4),profile=Profile.objects.get(pk=4))
        self.scheduler.schedule_execution(e3)
        self.scheduler.schedule_execution(e4)
        self.scheduler.schedule_execution(e5)
